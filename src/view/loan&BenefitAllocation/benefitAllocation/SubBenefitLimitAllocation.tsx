...
const SubBenefitLimitAllocation = ({
  register,
  control,
  setValue,
  watch,
  ...
  useEffect(() => {
    if (!!subBenefitId && subBenefits.length > 0) {
      setValue(
        `${subBenefitIndex}.subBenefitCode`,
        subBenefits?.find((b: any) => b.subBenefitId === subBenefitId)
          ?.subBenefitCode,
      );
      setValue(
        `${subBenefitIndex}.subBenefitName`,
        subBenefits?.find((b: any) => b.subBenefitId === subBenefitId)
          ?.subBenefitName,
      );
    }
